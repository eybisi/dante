...
public abstract class SettingsObject<V> implements Serializable
{
	...
	@Nullable
	public SettingsListener<V> listener = null;	//
	//////////////////////////////////////////////
	...
	public SettingsObject(String key,
						  ...
						  String summary,
						  int textViewTitleId,
						  @Nullable Integer textViewSummaryId,
						  boolean useValueAsSummary,
						  boolean addDivider,
						  ESettingsTypes type,
						  @Nullable Integer imageViewIconId,
						  @Nullable Integer iconDrawableId,
						  @Nullable Drawable iconDrawable,
						  @Nullable SettingsListener<V> listener)
	{
		this.key = key;
		this.title = title;
			...
			throws IllegalArgumentException
	{
		...
		{
			this.listener.onSettingsChanged(this, value, this.value);
		}
	}
	...
	public interface SettingsListener<V>
	{
		/**
		 * called when the value of this {@link SettingsObject} has changed
		 * @param newValue the new value of this {@link SettingsObject}
		 */
		void onSettingsChanged(SettingsObject<V> settingsObject, V newValue, V oldValue);
	...
	public static abstract class Builder<B extends Builder<B,V>, V>
	{
		 ...
		 * @return
		 */
		public B setIcon(@Nullable Integer iconId)
		{
		...
		public B setListener(SettingsListener<V> listener)
		{
			this.listener = listener;
			return (B) this;
		}
